...
<head>
	...
	var current_day_since_start_week = '';
		//On initialise le nom des mois et le nom des jours en VF <img src="../../bundles/tinymce/vendor/tiny_mce/plugins/emotions/img/smile.png" title=":)" alt=":)">
...
function alimenterChamps(daySelect){
        if(daySelect != ''){
            lastInput.value= current_year + separateur + formatInfZero((current_month+1)) + separateur + formatInfZero(daySelect);
        }
        else{
            lastInput.value = '';
        }
