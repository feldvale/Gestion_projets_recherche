...
<body>
	<?php
		...
		if($Data["projectName"] != NULL)
		{
				...
				$query = $query."nom LIKE '%".$Data["projectName"]."%'";
				$cond  = TRUE;
				$count++;
		}
	  ...
	  if($cond == TRUE)
	  {
		...
		if($vQuery != FALSE)
		{
		  ...
		  echo "ERROR:La requête n'est pas valide";
		}
	}
	else
	{
		   echo "ERROR:Aucun critere chosis";	
	}
